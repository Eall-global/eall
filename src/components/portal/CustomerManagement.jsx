    ...
    <div className="space-y-6 text-left">
          ...
          <div>
            ...
            <div className="mt-1">
              <AedPrice
                ...
                decimals={0}
                className="text-lg sm:text-xl font-black text-sky-900 truncate"
              />
            </div>
          </div>
      ...
      <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-2xs flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <button
          ...
          disabled={loading}
          className="inline-flex items-center gap-1.5 px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold rounded-xl transition cursor-pointer shrink-0"
        >
